...
public class CommandTestUtil {
    ...
    public static final String VALID_PRODUCT_PREFERENCE_BOB = "shampoo";
    public static final String VALID_DESCRIPTION_BOB = "Loves shampoo.";
    public static final String VALID_PRIORITY_BOB = "VIP";
    ...
    public static final String PREFERENCE_DESC_BOB = " " + PREFIX_PREFERENCE + VALID_PRODUCT_PREFERENCE_BOB;
